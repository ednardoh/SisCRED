...
uses
  ...
  DAO.Parcela in 'src\dao\DAO.Parcela.pas',
  Model.Parcela in 'src\model\Model.Parcela.pas',
  Model.ConsultaDividas in 'src\model\Model.ConsultaDividas.pas',
  DAO.ConsultaDividas in 'src\dao\DAO.ConsultaDividas.pas',
  Controller.ConsultaDividas in 'src\controllers\Controller.ConsultaDividas.pas';
...
begin
  ...
  Controllers.Credor.Registry;
  Controllers.Parcela.Registry;
  Controller.ConsultaDividas.Registry;
