...
begin
  try
    ...
    ParcelaModel.valor_total          := oJson.GetValue<string>('valor_total');
    ParcelaModel.dt_primeira_parcela  := oJson.GetValue<string>('dt_primeira_parcela');
    ParcelaModel.vl_primeira_parcela  := oJson.GetValue<string>('vl_primeira_parcela');
    ParcelaModel.dt_segunda_parcela   := oJson.GetValue<string>('dt_segunda_parcela');
    ParcelaModel.vl_segunda_parcela   := oJson.GetValue<string>('vl_segunda_parcela');
    ParcelaModel.dt_terceira_parcela  := oJson.GetValue<string>('dt_terceira_parcela');
    ParcelaModel.vl_terceira_parcela  := oJson.GetValue<string>('vl_terceira_parcela');
    ParcelaModel.dt_quarta_parcela    := oJson.GetValue<string>('dt_quarta_parcela');
    ParcelaModel.vl_quarta_parcela    := oJson.GetValue<string>('vl_quarta_parcela');
