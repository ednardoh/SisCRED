...
begin
  try
    ...
    try
      ...
      vQry.ParamByName('valor_total').AsString          := AParcelaModel.valor_total;
      vQry.ParamByName('dt_primeira_parcela').AsString  := AParcelaModel.dt_primeira_parcela;
      vQry.ParamByName('vl_primeira_parcela').AsString  := AParcelaModel.vl_primeira_parcela;
      vQry.ParamByName('dt_segunda_parcela').AsString   := AParcelaModel.dt_primeira_parcela;
      vQry.ParamByName('vl_segunda_parcela').AsString   := AParcelaModel.vl_segunda_parcela;
      vQry.ParamByName('dt_terceira_parcela').AsString  := AParcelaModel.dt_terceira_parcela;
      vQry.ParamByName('vl_terceira_parcela').AsString  := AParcelaModel.vl_terceira_parcela;
      vQry.ParamByName('dt_quarta_parcela').AsString    := AParcelaModel.dt_quarta_parcela;
      vQry.ParamByName('vl_quarta_parcela').AsString    := AParcelaModel.vl_quarta_parcela;
  ...
  try
    ...
    while not vQry.Eof do
      begin
        ...
        oJson.AddPair('valor_total'        , TJSONNumber.Create(vQry.FieldByName('valor_total').AsString));
